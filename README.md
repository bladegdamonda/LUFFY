...
│   ├── deepscaler/        # Scaling utilities (OpenAI integrated; Gemini pending)
...
- OpenAI API integration is implemented; Gemini remains a placeholder implementation
- FSDP and distributed training features need completion


### 🔴 High Priority TODOs

- **API Integration**: Complete Gemini support and OpenAI logging, batching, and timeout configuration
